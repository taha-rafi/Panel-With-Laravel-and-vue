<template>
    <div>
        <template v-if="customType == 'menu'">
            <a-menu-item @click="showAdd" key="subscription_plans">
                <template #icon>
                    <slot name="icon"></slot>
                </template>
                <slot></slot>
        ...
        <template v-else>
            <a-tooltip
                v-if="tooltip"
                placement="topLeft"
                :title="$t('subscription_plans.add')"
        ...
        <AddEdit
            ...
            :formData="formData"
            :data="formData"
            :pageTitle="$t('subscription_plans.add')"
            :successMessage="$t('subscription_plans.created')"
        />
    </div>
</template>
<script>
