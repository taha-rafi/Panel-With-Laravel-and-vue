<template>
    <div>
        <template v-if="customType == 'menu'">
            <a-menu-item @click="showAdd" key="offline_payment_mode">
                <template #icon>
                    <slot name="icon"></slot>
                </template>
                <slot></slot>
        ...
        <template v-else>
            <a-tooltip
                v-if="tooltip"
                placement="topLeft"
                :title="$t('offline_payment_mode.add')"
        ...
        <AddEdit
            ...
            :formData="formData"
            :data="formData"
            :pageTitle="$t('offline_payment_mode.add')"
            :successMessage="$t('offline_payment_mode.created')"
        />
    </div>
</template>
<script>
