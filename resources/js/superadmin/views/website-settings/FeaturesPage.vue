...
import InnerFeaturePage from "./features/InnerFeaturePage.vue";
...
export default {
	...
	setup(props) {
		...
		const { details } = fields("features_page");
		...
		const submitSuccess = (submittedFullData) => {
			landingWebsite.tableData.value = submittedFullData;
		};
